import time
from msg_srv_act_interface_ex.msg import ArithmeticArgument
from msg_srv_act_interface_ex.srv import ArithmeticOperator
...
class Calculator(Node):
    ...
    def __init__(self):
        ...
        self. arithmetic_srv_server = self.create_service(
            ArithmeticOperator,
            'arithmetic_operator',
