...
from my_turtlesim_mobeturtle_pkg.my_subscriber import TurtlesimSubscriber
...
class DistTurtleServer(Node):
    def __init__(self):
        ...
        output_msg = output_msg + "and almosts_tim is " + str(self.almosts_time) + ". "
