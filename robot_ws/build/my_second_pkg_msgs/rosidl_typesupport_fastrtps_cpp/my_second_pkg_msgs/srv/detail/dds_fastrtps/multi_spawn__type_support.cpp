...
#include "my_second_pkg_msgs/srv/detail/multi_spawn__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_second_pkg_msgs::srv::MultiSpawn_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_second_pkg_msgs::srv::MultiSpawn_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_second_pkg_msgs::srv::MultiSpawn_Request *>(
    untyped_ros_message);
...
{
  return &my_second_pkg_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_second_pkg_msgs::srv::MultiSpawn_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_second_pkg_msgs::srv::MultiSpawn_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_second_pkg_msgs::srv::MultiSpawn_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_second_pkg_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn_Response__handle;
}
...
{
  return &my_second_pkg_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn__handle;
}
