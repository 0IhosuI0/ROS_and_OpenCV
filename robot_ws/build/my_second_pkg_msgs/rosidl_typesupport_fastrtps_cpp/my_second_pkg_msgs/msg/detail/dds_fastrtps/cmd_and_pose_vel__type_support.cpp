...
#include "my_second_pkg_msgs/msg/detail/cmd_and_pose_vel__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_second_pkg_msgs::msg::CmdAndPoseVel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_second_pkg_msgs::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_second_pkg_msgs::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  return &my_second_pkg_msgs::msg::typesupport_fastrtps_cpp::_CmdAndPoseVel__handle;
}
