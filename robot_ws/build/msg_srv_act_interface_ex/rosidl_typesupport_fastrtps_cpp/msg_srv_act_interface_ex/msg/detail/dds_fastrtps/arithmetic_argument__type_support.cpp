...
#include "msg_srv_act_interface_ex/msg/detail/arithmetic_argument__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_srv_act_interface_ex::msg::ArithmeticArgument;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_srv_act_interface_ex::msg::ArithmeticArgument *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_srv_act_interface_ex::msg::ArithmeticArgument *>(
    untyped_ros_message);
...
{
  return &msg_srv_act_interface_ex::msg::typesupport_fastrtps_cpp::_ArithmeticArgument__handle;
}
