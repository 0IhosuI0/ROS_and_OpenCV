...
#include "msg_srv_act_interface_ex/srv/detail/arithmetic_operator__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_srv_act_interface_ex::srv::ArithmeticOperator_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_srv_act_interface_ex::srv::ArithmeticOperator_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_srv_act_interface_ex::srv::ArithmeticOperator_Request *>(
    untyped_ros_message);
...
{
  return &msg_srv_act_interface_ex::srv::typesupport_fastrtps_cpp::_ArithmeticOperator_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_act_interface_ex::srv::ArithmeticOperator_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_srv_act_interface_ex::srv::ArithmeticOperator_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<msg_srv_act_interface_ex::srv::ArithmeticOperator_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &msg_srv_act_interface_ex::srv::typesupport_fastrtps_cpp::_ArithmeticOperator_Response__handle;
}
...
{
  return &msg_srv_act_interface_ex::srv::typesupport_fastrtps_cpp::_ArithmeticOperator__handle;
}
