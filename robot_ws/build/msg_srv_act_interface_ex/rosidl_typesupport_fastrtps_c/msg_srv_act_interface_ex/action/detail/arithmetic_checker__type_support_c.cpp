...
#include "msg_srv_act_interface_ex/action/detail/arithmetic_checker__rosidl_typesupport_fastrtps_c.h"
...
using _ArithmeticChecker_Goal__ros_msg_type = msg_srv_act_interface_ex__action__ArithmeticChecker_Goal;
...
size_t get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Goal(
  const void * untyped_ros_message,
...
static uint32_t _ArithmeticChecker_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_srv_act_interface_ex__action__ArithmeticChecker_Goal;
    is_plain =
      (
...
static size_t _ArithmeticChecker_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_Goal)() {
...
using _ArithmeticChecker_Result__ros_msg_type = msg_srv_act_interface_ex__action__ArithmeticChecker_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticChecker_Result__ros_msg_type * ros_message = static_cast<const _ArithmeticChecker_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_act_interface_ex__action__ArithmeticChecker_Result;
    is_plain =
      (
...
static size_t _ArithmeticChecker_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_Result)() {
...
using _ArithmeticChecker_Feedback__ros_msg_type = msg_srv_act_interface_ex__action__ArithmeticChecker_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticChecker_Feedback__ros_msg_type * ros_message = static_cast<const _ArithmeticChecker_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_act_interface_ex__action__ArithmeticChecker_Feedback;
    is_plain =
      (
...
static size_t _ArithmeticChecker_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_Feedback)() {
...
// already included above
// #include "msg_srv_act_interface_ex/action/detail/arithmetic_checker__functions.h"  // goal
...
using _ArithmeticChecker_SendGoal_Request__ros_msg_type = msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticChecker_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _ArithmeticChecker_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Request;
    is_plain =
      (
...
static size_t _ArithmeticChecker_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_SendGoal_Request)() {
...
using _ArithmeticChecker_SendGoal_Response__ros_msg_type = msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticChecker_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _ArithmeticChecker_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Response;
    is_plain =
      (
...
static size_t _ArithmeticChecker_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_SendGoal)() {
...
using _ArithmeticChecker_GetResult_Request__ros_msg_type = msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticChecker_GetResult_Request__ros_msg_type * ros_message = static_cast<const _ArithmeticChecker_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Request;
    is_plain =
      (
...
static size_t _ArithmeticChecker_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_GetResult_Request)() {
...
// already included above
// #include "msg_srv_act_interface_ex/action/detail/arithmetic_checker__functions.h"  // result
...
using _ArithmeticChecker_GetResult_Response__ros_msg_type = msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticChecker_GetResult_Response__ros_msg_type * ros_message = static_cast<const _ArithmeticChecker_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Response;
    is_plain =
      (
...
static size_t _ArithmeticChecker_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_GetResult)() {
...
// already included above
// #include "msg_srv_act_interface_ex/action/detail/arithmetic_checker__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _ArithmeticChecker_FeedbackMessage__ros_msg_type = msg_srv_act_interface_ex__action__ArithmeticChecker_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticChecker_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _ArithmeticChecker_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_srv_act_interface_ex
size_t max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_act_interface_ex__action__ArithmeticChecker_FeedbackMessage;
    is_plain =
      (
...
static size_t _ArithmeticChecker_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_act_interface_ex__action__ArithmeticChecker_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_act_interface_ex, action, ArithmeticChecker_FeedbackMessage)() {
