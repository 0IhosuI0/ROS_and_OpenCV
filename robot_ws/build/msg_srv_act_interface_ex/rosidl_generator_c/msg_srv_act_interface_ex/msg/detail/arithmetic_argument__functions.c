...
msg_srv_act_interface_ex__msg__ArithmeticArgument__init(msg_srv_act_interface_ex__msg__ArithmeticArgument * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    msg_srv_act_interface_ex__msg__ArithmeticArgument__fini(msg);
    return false;
  }
  // argument_a
  // argument_b
...
msg_srv_act_interface_ex__msg__ArithmeticArgument__create()
{
  ...
  msg_srv_act_interface_ex__msg__ArithmeticArgument * msg = (msg_srv_act_interface_ex__msg__ArithmeticArgument *)allocator.allocate(sizeof(msg_srv_act_interface_ex__msg__ArithmeticArgument), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msg_srv_act_interface_ex__msg__ArithmeticArgument));
  bool success = msg_srv_act_interface_ex__msg__ArithmeticArgument__init(msg);
  if (!success) {
...
msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence__init(msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msg_srv_act_interface_ex__msg__ArithmeticArgument * data = NULL;

  if (size) {
    data = (msg_srv_act_interface_ex__msg__ArithmeticArgument *)allocator.zero_allocate(size, sizeof(msg_srv_act_interface_ex__msg__ArithmeticArgument), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msg_srv_act_interface_ex__msg__ArithmeticArgument__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        msg_srv_act_interface_ex__msg__ArithmeticArgument__fini(&data[i - 1]);
      }
...
msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence__fini(msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      msg_srv_act_interface_ex__msg__ArithmeticArgument__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence * array = (msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence *)allocator.allocate(sizeof(msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence__init(array, size);
  if (!success) {
...
msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence__destroy(msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence__are_equal(const msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence * lhs, const msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!msg_srv_act_interface_ex__msg__ArithmeticArgument__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  msg_srv_act_interface_ex__msg__ArithmeticArgument__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(msg_srv_act_interface_ex__msg__ArithmeticArgument);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    msg_srv_act_interface_ex__msg__ArithmeticArgument * data =
      (msg_srv_act_interface_ex__msg__ArithmeticArgument *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msg_srv_act_interface_ex__msg__ArithmeticArgument__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          msg_srv_act_interface_ex__msg__ArithmeticArgument__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!msg_srv_act_interface_ex__msg__ArithmeticArgument__copy(
