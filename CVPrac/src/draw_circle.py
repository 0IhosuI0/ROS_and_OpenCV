...
orange, blue, miku = (0, 165, 255), (255, 0, 0), (183, 163, 39)
...
cv2.circle(image, pt2, 70, miku, -1)

font = cv2.FONT_HERSHEY_COMPLEX
cv2.putText(image, 'center_blue', center, font, 1.0, blue)
cv2.putText(image, 'pt1_orange', pt1, font, 0.8, orange)
cv2.putText(image, 'pt2_miku', shade, font, 1.2, black, 2)
cv2.putText(image, 'pt2_miku', pt2, font, 1.2, miku, 1)

cv2.imshow("Dtaw circles", image)
cv2.waitKey(0)
