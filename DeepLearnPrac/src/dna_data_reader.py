...
class DataReader():
    ...
    def read_data(self):
        print("Reading Data...")
        files = os.listdir("data/data_dna")
        data = []
        for i, file in enumerate(files):
            book = np.loadtxt("data/data_dna/" + file, delimiter=",", dtype=np.float32).transpose()
...
def draw_graph(history):
    ...
    fig.savefig("dna3_train_history.png")
    ...
    plt.plot(train_history, "red")
    plt.plot(validation_history, 'blue')
    fig.savefig("dna3_accuracy_history.png")
